...
INSERT INTO pergunta (id, texto, conteudo_id) VALUES (1, 'O que é a AWS?', 1);
...
INSERT INTO pergunta (id, texto, conteudo_id) VALUES (2, 'Quais são os principais benefícios da AWS?', 1);
...
INSERT INTO pergunta (id, texto, conteudo_id) VALUES (3, 'O que é o Amazon S3?', 3);
...
INSERT INTO pergunta (id, texto, conteudo_id) VALUES (4, 'O que é o Amazon EFS?', 4);
...
INSERT INTO pergunta (id, texto, conteudo_id) VALUES (5, 'Para que serve o Amazon Glacier?', 5);
...
INSERT INTO pergunta (id, texto, conteudo_id) VALUES (6, 'Quais são as principais opções de backup na AWS?', 6);
...
INSERT INTO pergunta (id, texto, conteudo_id) VALUES (7, 'Qual serviço AWS é recomendado para arquivamento?', 7);
